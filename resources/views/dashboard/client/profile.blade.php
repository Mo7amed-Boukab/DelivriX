...
@section('main')
<div class="px-4 pt-24 mx-auto w-full bg-white sm:px-6 lg:px-24">
            ...
            <div class="p-6 h-full bg-white rounded-lg border border-gray-50 shadow-sm">
                <div class="flex flex-col items-center">
                    ...
                    <div class="mt-4 w-full">
                        <form action="{{ route('client.profile.photo') }}" method="POST" enctype="multipart/form-data" class="w-full">
                            @csrf
                            @method('PUT')
                            <div class="relative">
            ...
            <div class="p-6 h-full bg-white rounded-lg border border-gray-50 shadow-sm">
                ...
                <form action="{{ route('client.profile.update') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                        <div>
                            <label class="block mb-1 text-sm text-gray-700">Nom</label>
                        ...
                        <div>
                            ...
                            <input type="tel" name="phone" value="{{ old('telephone', $user->phone) }}" class="px-4 py-2 w-full text-sm text-gray-600 bg-transparent rounded-md border border-gray-200 shadow-sm transition duration-300 placeholder:text-gray-400 ease focus:outline-none focus:border-gray-400 hover:border-gray-300 focus:shadow @error('telephone') border-red-500 @enderror">
                            @error('phone')
                                <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                            @enderror
                        </div>
                        <div>
                            ...
                            <input type="tel" name="ville" value="{{ old('ville', $user->ville) }}" class="px-4 py-2 w-full text-sm text-gray-600 bg-transparent rounded-md border border-gray-200 shadow-sm transition duration-300 placeholder:text-gray-400 ease focus:outline-none focus:border-gray-400 hover:border-gray-300 focus:shadow @error('telephone') border-red-500 @enderror">
                            @error('ville')
                                <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                            @enderror
                        </div>
